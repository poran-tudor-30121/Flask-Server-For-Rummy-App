...
from main_processing import process_divisions_async, find_rectangular_contours_with_fixed_threshold, \
    process_image_for_all_players, process_image_for_some_players
...
def main(image_path, tesseract_path):
    ...
    result = loop.run_until_complete(process_image_for_some_players(image_path, logger,wanted_sections=['left', 'bottom']))
    logger.info(result)
